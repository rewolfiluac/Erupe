-- Adds an HR5 guide reward distribution to existing databases.
-- Based on official server screenshots under repository-root/screenshot.
...
BEGIN
    ...
    WHERE type = 1
      ...
      AND description LIKE '%HR5を突破したハンターにギルドからの褒賞品です！%'
    LIMIT 1;
